...
public class Spawner : MonoBehaviour
{
    ...
    public float maxSpawnTime = 2.5f; //Maximum amount of time between spawning objects
    ...
    void Update()
    {
        ...
        //if we've counted past the amount of time wait...
        if (timeSinceLastSpawn > timeToNextSpawn)
        {
            ...
            //Instantiate spawns a GameObject - in this case we tell it to spawn a GameObject from our objectssToSpawn list
            //The second parameter in the brackets tell it where to spawn, so we've entered tyhe postions of the spawner.
